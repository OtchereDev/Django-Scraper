...
from api.views import ActivateScrapping, GetFilteredJobsByCompanyName, GetFilteredJobsByCreated, GetFilteredJobsByLocation, GetFilteredJobsBySalary, GetFilteredJobsByTag, GetJobs, GetJobsFromDocs, GetJobsTags
